...
<body>
    <nav class="navbar navbar-expand-lg" style="background: #FFA800 ; border : 3px solid #FF7A00">
        <div class="container-fluid">
            ...
            <a href="connexion.php" class="btn btn-primary" type="submit" style = "background: #4F5B5E; margin-left: auto; ">Se connecter</a>
        </div>
    </nav>
            ...
            <div class="container"
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row">
                        ...
                        <br><br>
                        <div class="col-12">
                            <input class="form-control" type="text" placeholder="Ville" id="city_inscription">
                        </div>
                        <br><br>
                        <div class="row">
                            <p></p>
